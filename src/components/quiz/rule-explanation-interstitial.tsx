...
export function RuleExplanationInterstitial({
  ...
  return (
    <div className="min-h-screen bg-paper flex items-center justify-center px-4 py-12 animate-fade-in">
      <div className="w-full max-w-xl">
        <p className="text-sm text-muted mb-3 text-center">
          {t.quiz.interstitialIntro}
        </p>

        <div className="bg-surface rounded-xl shadow-sm border border-chalk p-6 md:p-8">
          {/* Title */}
          <h2 className="text-xl md:text-2xl font-semibold text-ink mb-4 leading-snug">
            {explanation.title}
          </h2>

          {/* Body */}
          <div className="text-base text-ink/90 leading-relaxed mb-6">
